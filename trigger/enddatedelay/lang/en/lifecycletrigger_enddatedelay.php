...
$string['pluginname'] = 'End date delay trigger';

$string['delay'] = 'Delay from end of course until starting a process';
$string['delay_help'] = 'The trigger will be invoked if the time passed since the course has finished (end date) is longer than this delay.';
